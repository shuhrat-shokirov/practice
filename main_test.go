...
func TestStoreRevenue(t *testing.T) {
	tests := []struct {
		...
		{"If all employees work equally",[][]int{{10, 10, 10, 15}, {10, 10, 10, 15}, {10, 10, 10, 15}},[]int{1, 2, 3}, []int{1, 2, 3}, []int{1, 2, 3},[]int{1, 2, 3}},
		{"Workers worked differently",[][]int{{7, 1, 2, 3}, {10, 10, 10, 15}, {7, 20, 2}},[]int{2}, []int{2}, []int{3},[]int{1}},
		{"Some days workers converge",[][]int{{7, 1, 2, 3}, {10, 10, 10, 15}, {7, 1, 2}},[]int{2}, []int{2}, []int{2},[]int{1, 3}},
		// TODO: Add test cases.
	}
	for _, tt := range tests {
			gotIndexOfMaxRevenue, gotIndexOfAverageDailyRevenue, gotIndexTheBestDailyRevenue, gotIndexTheWorstDailyRevenue := storeRevenue(tt.Revenues)
